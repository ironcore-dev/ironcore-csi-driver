...
//		InClusterClient: nil,
//		OnMetalClient:   suite.clientMock,
//	}
//	service := driver{kubeHelper: kubeHelper}
...
//	service := driver{parentClient: suite.clientMock, kubeHelper: suite.kubehelper}
...
//	client := &util.Kubeclient{Client: fc}
//	suite.kubehelper.On("BuildInclusterClient").Return(client, nil)
//	annotation := util.Annotation{OnmetalMachine: "test1", OnmetalNamespace: "test2"}
...
//	service := driver{parentClient: suite.clientMock}
...
//}
//
//func (k *KubeHelper) BuildInclusterClient() (*util.Kubeclient, error) {
//	args := k.Called()
//	client, _ := args.Get(0).(*util.Kubeclient)
//	return client, nil
//}
//
//func (k *KubeHelper) NodeGetAnnotations(Nodename string, client kubernetes.Interface) (a util.Annotation, err error) {
//	args := k.Called(Nodename, client)
//	annotation, _ := args.Get(0).(util.Annotation)
