...
deploy:
	cd config/controller/manager && $(KUSTOMIZE) edit set image onmetal-csi-driver=${IMG}
	$(KUSTOMIZE) build config/controller/default | kubectl apply -f -

undeploy:
	$(KUSTOMIZE) build config/controller/default | kubectl delete -f -
